...
class ExtractPath:
    def __init__(self,
        ...
        if (self.user != None) & (self.date != None):
            ...
            self.video_path_file_s3_key = f'TikTokData/TikTokDataforCreators/extract/videos/{self.user}/{self.date.strftime(self.datetime_format)}'
            ...
            self.data_path_file_s3_key = f'TikTokData/TikTokDataforCreators/extract/data/{self.user}/{self.date.strftime(self.datetime_format)}.csv'
